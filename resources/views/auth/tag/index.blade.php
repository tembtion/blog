                    ...
                    <div class="ibox-content">
                        ...
                        @if ($tag)
                            <table class="footable table table-stripped footable-loaded" id="editable">
                                ...
                                <tfoot>
                                <tr>
                                    <td colspan="5"><span class="pull-right">{!! $tag->render() !!}</span></td>
                                </tr>
                                </tfoot>
                            </table>
                        @else
...
<script>
$(function(){
    var add_url = "{{ URL::route('authTagAdd') }}";
    var edit_url = "{{ URL::route('authTagEdit') }}";
    var delete_url = "{{ URL::route('authTagDelete') }}";
